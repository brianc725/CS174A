...
// this will make a sun with a sphere center and tips around it 
window.Complex_Shape = window.classes.Complex_Shape =
class Complex_Shape extends Shape                                   // An axis set with arrows, made out of a lot of various primitives.
{ constructor(rows, columns)
    { super( "positions", "normals", "texture_coords" );

       Grid_Sphere  .insert_transformed_copy_into( this, [ rows, columns ] );
       //right ray
       Cone_Tip     .insert_transformed_copy_into( this, [ rows, columns ], Mat4.rotation(Math.PI/2, Vec.of(0,1,0)).times(Mat4.scale([0.75,0.75,0.75])).times(Mat4.translation([0,0,1.5])) );
       //coming out  ray 
       Cone_Tip     .insert_transformed_copy_into( this, [ rows, columns ], Mat4.rotation(0, Vec.of(0,1,0)).times(Mat4.scale([0.75,0.75,0.75])).times(Mat4.translation([0,0,1.5])) );
       //going in  ray
       Cone_Tip     .insert_transformed_copy_into( this, [ rows, columns ], Mat4.rotation(Math.PI, Vec.of(1,0,0)).times(Mat4.scale([0.75, 0.75, 0.75])).times(Mat4.translation([0, 0, 1.5])));
       //left ray
       Cone_Tip     .insert_transformed_copy_into( this, [ rows, columns ], Mat4.rotation(3*Math.PI/2, Vec.of(0,1,0)).times(Mat4.scale([0.75,0.75,0.75])).times(Mat4.translation([0,0,1.5])) );
       //bottom ray 
       Cone_Tip     .insert_transformed_copy_into( this, [ rows, columns ], Mat4.rotation(Math.PI/2, Vec.of(1,0,0)).times(Mat4.scale([0.75,0.75,0.75])).times(Mat4.translation([0,0,1.5])) );
       //top ray 
       Cone_Tip     .insert_transformed_copy_into( this, [ rows, columns ], Mat4.rotation(3*Math.PI/2, Vec.of(1,0,0)).times(Mat4.scale([0.75,0.75,0.75])).times(Mat4.translation([0,0,1.5])) );

       //front circle
       Torus        .insert_transformed_copy_into( this, [ rows, columns ], Mat4.identity().times(Mat4.scale([0.4,0.4,0.1])).times(Mat4.translation([0,0,4.5])));
    }
}
